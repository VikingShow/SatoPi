 ...
 * CodeBlock uses Shiki (via @satopi/pi-web/shiki) instead of hljs.
 */

import { highlightCode } from "@satopi/pi-web/shiki";
...
export function PathText({ path, from, to }: { path: string; from?: number | null; to?: number | null }): ReactNode {
	let range = "";
...
export function CodeBlock({
	...
	return (
		<div className="tv-out">
			{html ? (
				<div
					className="[&_pre]:bg-[#0d0d0d]! [&_pre]:p-3 [&_pre]:overflow-x-auto [&_pre]:text-xs [&_pre]:rounded-lg"
