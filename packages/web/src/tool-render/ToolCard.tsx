...
import { Badge, CodeBlock, DiffBlock, Output, PathText } from "./parts";
...
export function ToolCard({ tool, file, summary, detail, duration, exitCode, collapsed = true }: ToolCardProps) {
	...
	return (
		<div className="tv-card my-1 rounded-lg border border-border overflow-hidden">
			...
			>
				...
				{exitCode !== undefined && exitCode !== 0 && <Badge tone="err">exit {exitCode}</Badge>}
			</button>
