...
import { buildSpec, type CompletionSpec, generateCompletion } from "@satopi/pi-coding-agent/cli/completion-gen";
import type { CliConfig, CommandCtor } from "@satopi/pi-utils/cli";
