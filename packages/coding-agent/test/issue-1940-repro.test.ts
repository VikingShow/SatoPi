...
import { SttClient } from "@satopi/pi-coding-agent/stt/asr-client";
import type { SttWorkerInbound, SttWorkerOutbound } from "@satopi/pi-coding-agent/stt/asr-protocol";
import { TinyTitleClient } from "@satopi/pi-coding-agent/tiny/title-client";
import type { TinyTitleWorkerInbound, TinyTitleWorkerOutbound } from "@satopi/pi-coding-agent/tiny/title-protocol";
