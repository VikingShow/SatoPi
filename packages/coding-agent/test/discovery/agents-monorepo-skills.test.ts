...
import { clearCache, readFile } from "@satopi/pi-coding-agent/capability/fs";
...
import { getProjectPathCandidates } from "@satopi/pi-coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/VikingShow/SatoPi/issues/1116:
