...
import { loadCapability } from "@satopi/pi-coding-agent/capability";
...
import { loadSlashCommands } from "@satopi/pi-coding-agent/extensibility/slash-commands";
import { discoverAgents } from "@satopi/pi-coding-agent/task/discovery";
import { removeWithRetries } from "@satopi/pi-utils";
import "@satopi/pi-coding-agent/discovery/claude-plugins";
import { type MCPServer, mcpCapability } from "@satopi/pi-coding-agent/capability/mcp";
import type { Skill } from "@satopi/pi-coding-agent/capability/skill";
import type { SlashCommand } from "@satopi/pi-coding-agent/capability/slash-command";
