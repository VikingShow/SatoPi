...
import { createOpenAIResponsesHistoryPayload } from "@satopi/pi-ai/utils";
...
import type { SessionEntry, SessionMessageEntry } from "@satopi/pi-coding-agent/session/store/session-entries";
