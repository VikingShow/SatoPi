...
import { applyDisabledExtensionsToState } from "@satopi/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@satopi/pi-coding-agent/modes/components/extensions/types";
