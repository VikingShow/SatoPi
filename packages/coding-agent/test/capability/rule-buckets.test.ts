...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@satopi/pi-coding-agent/capability/rule";
import { bucketRules } from "@satopi/pi-coding-agent/capability/rule-buckets";
