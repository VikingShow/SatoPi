...
import { MCPOAuthFlow, refreshMCPOAuthToken } from "@satopi/pi-coding-agent/mcp/oauth-flow";
...
describe("mcp oauth flow", () => {
	it("uses satopi client name for dynamic client registration", async () => {
		...
		expect((registrationPayload as { client_name?: string } | null)?.client_name).toBe("satopi");
