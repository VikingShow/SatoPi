...
} from "@satopi/pi-coding-agent/slash-commands/builtin-registry";
import { CollabQrCodeComponent } from "@satopi/pi-coding-agent/slash-commands/helpers/collab-qrcode";
import { Spacer } from "@satopi/pi-tui";
