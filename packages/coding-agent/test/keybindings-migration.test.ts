...
import { matchesAppFollowUp } from "@satopi/pi-coding-agent/modes/utils/keybinding-matchers";
import { type KeybindingsConfig, setKeybindings } from "@satopi/pi-tui";
import {
...
`,
	...
	it("merges default user keybindings when create uses the active profile with no arguments (#4867)", async () => {
		...
		try {
			...
			restoreEnvValue("STP_PROFILE", originalStpProfile);
