 ...
 * `~/.stp/agent/extensions/`) was invisible to model resolution and
...
import { AuthStorage } from "@satopi/pi-ai";
import { ModelRegistry } from "@satopi/pi-coding-agent/config/model-registry";
import { getModelMatchPreferences, resolveCliModel } from "@satopi/pi-coding-agent/config/model-resolver";
import { resetSettingsForTest, Settings } from "@satopi/pi-coding-agent/config/settings";
import { loadCliExtensionProviders } from "@satopi/pi-coding-agent/sdk";
