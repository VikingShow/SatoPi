...
import { renderSearchResult, type SearchRenderDetails } from "@satopi/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@satopi/pi-coding-agent/web/search/types";
