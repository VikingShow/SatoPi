...
import type { AgentToolCall } from "@satopi/pi-agent-core";
import type { SessionMessageEntry } from "@satopi/pi-agent-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@satopi/pi-agent-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@satopi/pi-agent-core/compaction/shake";
import type { ProtectedToolContext } from "@satopi/pi-agent-core/compaction/tool-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@satopi/pi-ai";
import { createPlanReadMatcher } from "@satopi/pi-coding-agent/plan-mode/plan-protection";
