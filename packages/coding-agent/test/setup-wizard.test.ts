...
import { runOnboardingSetup } from "@satopi/pi-coding-agent/commands/setup";
import { Settings } from "@satopi/pi-coding-agent/config/settings";
import { SETTINGS_SCHEMA } from "@satopi/pi-coding-agent/config/settings-schema";
import {
	ALL_SCENES,
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@satopi/pi-coding-agent/modes/setup-wizard";
import { WebSearchTab } from "@satopi/pi-coding-agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@satopi/pi-coding-agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_PREFERENCES } from "@satopi/pi-coding-agent/web/search/types";
