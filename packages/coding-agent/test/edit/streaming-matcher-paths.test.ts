 ...
 *
 * Regression: see https://github.com/VikingShow/SatoPi/issues/3646. Before the
...
import { EDIT_MODE_STRATEGIES } from "@satopi/pi-coding-agent/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@satopi/pi-coding-agent/capability/rule";
import type { LoadContext } from "@satopi/pi-coding-agent/capability/types";
// Register all discovery providers as a side effect.
import "@satopi/pi-coding-agent/discovery";
import { TtsrManager } from "@satopi/pi-coding-agent/export/ttsr";
