...
import type { AssistantMessage, Context, Message } from "@satopi/pi-ai";
import {
	...
	SecretObfuscator,
} from "@satopi/pi-coding-agent/secrets/obfuscator";
import { compileSecretRegex } from "@satopi/pi-coding-agent/secrets/regex";
