...
} from "@satopi/pi-coding-agent/telemetry-export";
...
process.env.OTEL_SERVICE_NAME = "satopi-export-probe";
...
const span = trace.getTracer("@satopi/pi-agent-core").startSpan("agent.llm_call");
