...
import { applyExtensionFlags, type ExtensionFlagSink } from "@satopi/pi-coding-agent/cli/extension-flags";
import { buildInitialMessage } from "@satopi/pi-coding-agent/cli/initial-message";
