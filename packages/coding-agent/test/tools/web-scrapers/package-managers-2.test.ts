...
import { handleChocolatey } from "@satopi/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@satopi/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@satopi/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@satopi/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@satopi/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@satopi/pi-coding-agent/web/scrapers/terraform";
