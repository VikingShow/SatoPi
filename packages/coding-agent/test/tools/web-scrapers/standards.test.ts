...
import { handleCheatSh } from "@satopi/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@satopi/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@satopi/pi-coding-agent/web/scrapers/tldr";
