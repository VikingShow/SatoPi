...
import { handleAur } from "@satopi/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@satopi/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@satopi/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@satopi/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@satopi/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@satopi/pi-coding-agent/web/scrapers/rubygems";
