...
import { handleArtifactHub } from "@satopi/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@satopi/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@satopi/pi-coding-agent/web/scrapers/discogs";
