...
import { handleArxiv } from "@satopi/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@satopi/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@satopi/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@satopi/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@satopi/pi-coding-agent/web/scrapers/types";
