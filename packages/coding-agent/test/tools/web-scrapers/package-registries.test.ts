...
import { handleCratesIo } from "@satopi/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@satopi/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@satopi/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@satopi/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@satopi/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@satopi/pi-coding-agent/web/scrapers/pypi";
