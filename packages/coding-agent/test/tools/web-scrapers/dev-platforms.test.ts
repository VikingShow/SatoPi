...
import { handleDevTo } from "@satopi/pi-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@satopi/pi-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@satopi/pi-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@satopi/pi-coding-agent/web/scrapers/lobsters";
