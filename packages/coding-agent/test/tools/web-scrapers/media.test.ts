...
import { handleHuggingFace } from "@satopi/pi-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@satopi/pi-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@satopi/pi-coding-agent/web/scrapers/vimeo";
