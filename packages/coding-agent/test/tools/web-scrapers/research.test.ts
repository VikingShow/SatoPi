...
import { handleBiorxiv } from "@satopi/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@satopi/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@satopi/pi-coding-agent/web/scrapers/wikidata";
