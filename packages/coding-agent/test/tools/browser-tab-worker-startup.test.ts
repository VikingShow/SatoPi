...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "@satopi/pi-coding-agent/tools/browser/tab-protocol";
import { initializeTabWorkerForTest } from "@satopi/pi-coding-agent/tools/browser/tab-supervisor";
