...
import { GreenCommand } from "@satopi/pi-coding-agent/extensibility/custom-commands/bundled/ci-green";
...
import type * as TypeBox from "@satopi/pi-coding-agent/extensibility/typebox";
