...
import { type ExtensionModule, extensionModuleCapability } from "@satopi/pi-coding-agent/capability/extension-module";
import { resetSettingsForTest, Settings } from "@satopi/pi-coding-agent/config/settings";
import { getCapability, initializeWithSettings } from "@satopi/pi-coding-agent/discovery";
import {
	discoverAndLoadExtensions,
	discoverExtensionPaths,
	loadExtensions,
} from "@satopi/pi-coding-agent/extensibility/extensions/loader";
