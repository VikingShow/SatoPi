...
import { LocalProtocolHandler } from "@satopi/pi-coding-agent/internal-urls/local-protocol";
...
import {
	...
	urlHyperlink,
	urlHyperlinkAlways,
} from "@satopi/pi-coding-agent/tui/hyperlink";
import * as terminalCaps from "@satopi/pi-tui";
...
describe("tryResolveInternalUrlSync", () => {
	...
	it("returns undefined for unsupported internal URL schemes", () => {
		...
		expect(tryResolveInternalUrlSync("stp://docs.md")).toBeUndefined();
	});
