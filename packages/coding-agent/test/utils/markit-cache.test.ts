...
import { Markit } from "@satopi/pi-coding-agent/markit";
import { convertBufferWithMarkit, convertFileWithMarkit } from "@satopi/pi-coding-agent/utils/markit";
import { pruneMarkitConversionCache } from "@satopi/pi-coding-agent/utils/markit-cache";
import { __resetDirsFromEnvForTests, getAgentDir, Snowflake, setAgentDir } from "@satopi/pi-utils";
...
describe("document conversion cache", () => {
	...
	afterEach(async () => {
		...
		restoreEnv("STP_PROFILE", originalStpProfile);
