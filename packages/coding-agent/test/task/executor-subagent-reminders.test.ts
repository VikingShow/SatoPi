...
import { AgentBusyError, type AgentTelemetryConfig, type Tracer } from "@satopi/pi-agent-core";
import { type AssistantMessage, Effort } from "@satopi/pi-ai";
...
} from "@satopi/pi-coding-agent/task/executor";
...
describe("runSubprocess yield reminders", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@satopi/pi-coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
