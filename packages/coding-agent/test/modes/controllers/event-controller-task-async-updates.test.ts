...
import type { ToolExecutionComponent } from "@satopi/pi-coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@satopi/pi-coding-agent/task/types";
import type { BashToolDetails } from "@satopi/pi-coding-agent/tools/bash";
