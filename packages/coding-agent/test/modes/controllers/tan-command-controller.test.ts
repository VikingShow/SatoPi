...
import type { AsyncJobRegisterOptions } from "@satopi/pi-coding-agent/async/job-manager";
import { Settings } from "@satopi/pi-coding-agent/config/settings";
import { TanCommandController } from "@satopi/pi-coding-agent/modes/controllers/tan-command-controller";
