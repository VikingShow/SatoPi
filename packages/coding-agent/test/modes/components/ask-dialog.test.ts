...
import type { ExtensionAskDialogQuestion } from "@satopi/pi-coding-agent/extensibility/extensions/types";
import { AskDialogComponent } from "@satopi/pi-coding-agent/modes/components/ask-dialog";
