...
import { resetActiveRulesForTests, setActiveRules } from "@satopi/pi-coding-agent/capability/rule";
...
import type { Skill } from "@satopi/pi-coding-agent/extensibility/skills";
import { resetActiveSkillsForTests, setActiveSkills } from "@satopi/pi-coding-agent/extensibility/skills";
...
import {
	...
	isInternalUrlPrefix,
} from "@satopi/pi-coding-agent/modes/internal-url-autocomplete";
import { PromptActionAutocompleteProvider } from "@satopi/pi-coding-agent/modes/prompt-action-autocomplete";
...
describe("internal-url-autocomplete", () => {
	...
	describe("router.complete dispatch", () => {
		...
		it("exposes the completion-capable schemes", () => {
			...
			expect(schemes).toEqual(["agent", "artifact", "history", "local", "memory", "rule", "skill", "ssh", "stp"]);
		});
	});
