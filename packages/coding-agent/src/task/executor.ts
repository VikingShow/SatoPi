...
import { SKILL_PROMPT_MESSAGE_TYPE, USER_INTERRUPT_LABEL } from "../session/message/messages";
import { truncateTail } from "../session/message/streaming-output";
import type { ArtifactManager } from "../session/shared/artifacts";
import { SessionManager } from "../session/store/session-manager";
import { getAgentSessionPath } from "../session/store/session-tree-paths";
...
export interface ExecutorOptions {
	 ...
	 * `.stp/tools/` FS scan in the subagent; the subagent then re-binds each
