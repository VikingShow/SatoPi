 ...
 */
import { APP_NAME, CONFIG_DIR_NAME, logger } from "@satopi/pi-utils";
 ...
 * setter table itself can stay free of `@satopi/pi-utils` runtime imports
...
export function getExtraHelpText(): string {
	return [
		...
		"  stp agents unpack           - Export bundled subagents to ~/.stp/agent/agents (default)",
		"  stp agents unpack --project - Export bundled subagents to ./.stp/agents",
	].join("\n");
}
