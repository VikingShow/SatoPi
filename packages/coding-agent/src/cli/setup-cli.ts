 ...
 *
 * Handles `stp setup` for onboarding and `stp setup <component>` for optional dependencies.
 */
import * as path from "node:path";
import { $which, APP_NAME, getProjectDir, getPythonEnvDir } from "@satopi/pi-utils";
import { $ } from "bun";
...
// package dependencies beyond a working interpreter. `stp setup python --check`
...
/**
 * Unified `stp setup speech` flow. Drives every {@link SpeechComponent} through
