 ...
 * `__stp_worker_mnemopi_embed` selector). The whole point of this module is
...
import type { StandardEmbeddingModel } from "@satopi/pi-mnemopi/core";
import { loadFastembed } from "@satopi/pi-mnemopi/core/fastembed-runtime";
