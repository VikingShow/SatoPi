...
import { type ApiKeyResolver, completeSimple } from "@satopi/pi-ai";
import { hostMatchesUrl } from "@satopi/pi-catalog/hosts";
import type { Mnemopi } from "@satopi/pi-mnemopi";
import type * as MnemopiDiagnoseNs from "@satopi/pi-mnemopi/diagnose";
import type { DiagnosticSummary } from "@satopi/pi-mnemopi/diagnose";
...
async function loadMnemopiDiagnose(): Promise<typeof MnemopiDiagnoseNs> {
	if (!mnemopiDiagnoseMod) {
		mnemopiDiagnoseMod = await import("@satopi/pi-mnemopi/diagnose");
	}
