 ...
 * isolated directory (`~/.stp/agent/managed-skills`) separate from
 * user-authored skills (`~/.stp/agent/skills`). They are discovered and
...
/** Resolve the isolated managed-skills directory (`~/.stp/agent/managed-skills`). */
