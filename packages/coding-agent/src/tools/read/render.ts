/**
 * tools/read/render.ts — TUI renderer for the read tool (stage 3 split).
 * Extracted from tools/read.ts; class + schema stay in ./index.ts.
 */
...
import { isRawSelector, parseSel, type ReadToolDetails } from "./shared";
