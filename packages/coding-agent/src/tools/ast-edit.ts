...
import { type AstReplaceChange, type AstReplaceFileChange, astEdit } from "@satopi/pi-natives";
import type { Component } from "@satopi/pi-tui";
import { replaceTabs, Text } from "@satopi/pi-tui";
import { $envpos, prompt, untilAborted } from "@satopi/pi-utils";
