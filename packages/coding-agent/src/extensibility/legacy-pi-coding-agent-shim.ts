 ...
 * `@satopi/pi-coding-agent` (or one of its aliased scopes like
 ...
 * the same module identity as a direct `@satopi/pi-coding-agent` import.
 */
...
import { getAgentDir, getProjectDir, parseFrontmatter as parseOmpFrontmatter } from "@satopi/pi-utils";
