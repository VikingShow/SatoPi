 ...
 * `@satopi/pi-ai` (or one of its aliased scopes like `@earendil-works/pi-ai`
 ...
 * bare package root. Subpath imports (`@satopi/pi-ai/oauth`, etc.)
 ...
 * `@satopi/pi-catalog/models`. `getModel`/`getModels` are the historical
