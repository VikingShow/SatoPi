...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `stp grievances` invocation working unchanged
	...
	static examples = [
		"stp grievances",
		"stp grievances list --tool find",
		"stp grievances clean --id 209",
		"stp grievances clean --tool find",
		"stp grievances clean --all",
		"stp grievances push",
	];
