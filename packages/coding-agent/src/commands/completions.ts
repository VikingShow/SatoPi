/**
 * `stp completions <bash|zsh|fish>` — print a shell completion script.
 *
 ...
 */
import { APP_NAME, VERSION } from "@satopi/pi-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@satopi/pi-utils/cli";
