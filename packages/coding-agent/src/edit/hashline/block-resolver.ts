 ...
 * primitive in `@satopi/pi-natives`, which infers the language from the file
 ...
 */
import type { BlockResolver } from "@satopi/hashline";
import { blockRangeAt } from "@satopi/pi-natives";
