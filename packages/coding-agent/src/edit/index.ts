import { MismatchError as HashlineMismatchError } from "@satopi/hashline";
import hashlineGrammar from "@satopi/hashline/grammar.lark" with { type: "text" };
import hashlineDescription from "@satopi/hashline/prompt.md" with { type: "text" };
