...
import type { AssistantMessage, ImageContent, Message, Usage, UsageReport } from "@satopi/pi-ai";
import type { Component, Container, EditorTheme, Loader, Spacer, Text, TUI } from "@satopi/pi-tui";
...
import type { HistoryStorage } from "../session/store/history-storage";
...
export interface InteractiveModeContext {
	...
	/** Re-mount the active crew's chat page after the overlay was dismissed. */
	resumeCrewView(): Promise<void>;
