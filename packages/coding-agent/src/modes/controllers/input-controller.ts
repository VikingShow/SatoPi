...
import { type AutocompleteProvider, matchesKey, type SlashCommand } from "@satopi/pi-tui";
import { $env, isEnoent, logger, sanitizeText } from "@satopi/pi-utils";
...
export class InputController {
	...
	handleCtrlZ(): void {
		...
		try {
			...
			// that shares omp's process group, and a `stp … | tee log` style
