...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "model", "mode", "swarm", "collab", "path", "git", "pr", "context_pct", "cost"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "mode", "swarm", "path", "git", "pr", "subagents"],
		rightSegments: [
			"session_name",
			"cache_hit",
			"token_in",
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "mode", "swarm", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"session_name",
			"token_in",
			"token_out",
