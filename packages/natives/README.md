...
```typescript
import { grep, find, encodeSixel } from "@SatoPi/pi-natives";
...
`@SatoPi/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @SatoPi/pi-natives-<platform>-<arch>
