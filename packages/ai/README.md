...
```bash
npm install @SatoPi/pi-ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "@SatoPi/pi-ai";
...
```typescript
import { z, Tool } from "@SatoPi/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@SatoPi/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@SatoPi/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@SatoPi/pi-ai";
...
```typescript
import { getModel, stream } from "@SatoPi/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@SatoPi/pi-ai";
...
```typescript
import { Model, stream } from "@SatoPi/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@SatoPi/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@SatoPi/pi-ai";
...
```typescript
import { getEnvApiKey } from "@SatoPi/pi-ai";
...
```typescript
import { loginGitHubCopilot } from "@SatoPi/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@SatoPi/pi-ai";
import * as fs from "node:fs";
