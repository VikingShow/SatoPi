...
import type { Api, Context, Model, ModelSpec } from "@satopi/pi-ai/types";
import { buildModel } from "@satopi/pi-catalog/build";
import { COPILOT_API_HEADERS } from "@satopi/pi-catalog/wire/github-copilot";
 ...
 * hint (an satopi extension that preserves native-resolution snapcompact
