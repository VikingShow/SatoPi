...
import { encodeResponse, encodeStream, parseRequest } from "@satopi/pi-ai/providers/openai-responses-server";
import type { AssistantMessage } from "@satopi/pi-ai/types";
