...
import { complete } from "@satopi/pi-ai/stream";
import type { Api, Context, ImageContent, Model, OptionsForApi, UserMessage } from "@satopi/pi-ai/types";
import { getBundledModel } from "@satopi/pi-catalog/models";
import { $which, removeSyncWithRetries } from "@satopi/pi-utils";
import { e2eApiKey } from "./oauth";

const TEMP_DIR = fs.mkdtempSync(path.join(os.tmpdir(), "stp-temp-images-"));
