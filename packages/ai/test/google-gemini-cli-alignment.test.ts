...
import * as geminiCliProvider from "@satopi/pi-ai/providers/google-gemini-cli";
import {
...
} from "@satopi/pi-ai/providers/google-gemini-cli";
import { getOAuthApiKey } from "@satopi/pi-ai/registry/oauth";
import type { AssistantMessageEvent, Context, FetchImpl, Model, TJsonSchema } from "@satopi/pi-ai/types";
import { buildModel } from "@satopi/pi-catalog/build";
import type { ModelSpec } from "@satopi/pi-catalog/types";
