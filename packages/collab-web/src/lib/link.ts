 ...
 * link/envelope half of `@satopi/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@satopi/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@satopi/pi-wire";
