...
Shared utilities for [SatoPi](https://github.com/VikingShow/SatoPi) packages. Zero ceremony, Bun-first.
...
Import from the root barrel or per-module subpaths (`@SatoPi/pi-utils/<module>`).

## Install

```sh
bun add @SatoPi/pi-utils
```
