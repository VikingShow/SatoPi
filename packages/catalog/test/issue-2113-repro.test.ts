...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "@satopi/pi-ai/providers/openai-completions";
import type { AssistantMessage, Context } from "@satopi/pi-ai/types";
...
import { moonshotModelManagerOptions } from "@satopi/pi-catalog/provider-models/openai-compat";
import type { Model, ModelSpec } from "@satopi/pi-catalog/types";
