...
- Package: `@satopi/swarm-extension`; bin: `omp-swarm`.
...
- Package: private `@satopi/terminal-bench`; bin: `tb2`.
...
- Package: `@satopi/omp-stats`; bin: `omp-stats`; main user path: `omp stats`.
...
- Package: private `@satopi/typescript-edit-benchmark`; bin: `typescript-edit-benchmark`.
