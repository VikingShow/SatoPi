...
# terminal transcript.
#
# Prepare a directory (default ~/stp-signing) containing:
...
#   STP_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/stp-signing
...
DIR="${DIR:-${STP_SIGNING_DIR:-$HOME/stp-signing}}"
REPO="${STP_REPO:-VikingShow/SatoPi}"
